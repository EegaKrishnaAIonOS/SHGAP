...
| [0028](../adr/0028-market-linkage-dashboards.md)                  | Dashboards: discrete value-scaled Leaflet markers (not a smoothed heatmap or Mapbox), geo-activity endpoint added to T18's analytics module, first shared data-fetching hook, client-side PDF/Excel export, RBAC-gating fix, lazy-loaded dashboards to fix PWA precache limit, fixed a real district/ULB filter bug in 5 T18 endpoints (T19) |
